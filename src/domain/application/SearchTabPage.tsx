						...
						<td key="lftPnl">
							<table>
								...
								<tr>
									<td>
										Search for: &nbsp;
										<select key="selEntity" onChange={this.onSelChange} value={this.state.selEntity}>
											<option key="defEnt" value="">--Select--</option>
											{
								...
								<tr>
									<td>
										in columns: &nbsp;
										<select multiple={true} key="selCols" onChange={this.onSelCols} value={this.state.selCols}>
											{
								...
								<tr>
									<td>
										Query: &nbsp;
										<input type="text" key="search" onChange={this.handleChange}
								...
								<tr>
									<td>
										<button key="searchBtn" onClick={this.submit}>Search</button>
									</td>
								</tr>
								</tbody>
							</table>
